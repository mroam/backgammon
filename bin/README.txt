...
[ ]Improve ai's switchStrategy, which now only chooses PointBuildStrategy when startGame is stuck...
...
higher points? Exanple: white is bearing off (to 25+), has blots on 24,23,22. Rolls 1,6.
